...
<body>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="registrationForm1" action="/crudphpproject/index.php" method="post">
  ...
  <div class="container" class="m-300">
    ...
    <form id="registrationForm" action="/crudphpproject/index.php" method="post">
      <div class="form-group">
        <label for="fullName">Full Name</label>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener('click', (e) => {
        ...
        if (confirm("Are you want to Delete this Details")) {
          console.log("yes");
          window.location=`/crudphpproject/index.php?delete=${sno}`;
        } else {
          console.log("no");
        }
      })
